...
import {
  to = authentik_group.authentik_agent-users
  id = "f5965d62-cf25-4d4d-bc09-01fa1f0cc1dc"
}
import {
  to = authentik_group.authentik_read-only
...
import {
  to = authentik_group.gcp-viewers
  id = "55d82b2e-a5a3-42dd-a289-a33c2d670b7f"
}
import {
  to = authentik_group.grafana-dashboard-creators
  id = "a3ae0181-e07b-4715-aea9-188b4e1bc24a"
}
import {
  to = authentik_group.grafana-metrics-explorers
  id = "433819e7-26e8-4cf2-94de-f99bfc465a07"
}
import {
  to = authentik_group.netbox-admin
  id = "6b01a16f-322e-437b-8c9b-f303c4527d9d"
}
import {
  to = authentik_group.netbox-editor
  id = "a47a7322-c5ca-4f36-af3b-17c333eede39"
}
import {
  to = authentik_group.netbox-viewer
  id = "91a95b01-d6f2-4a48-912b-6e8f9b54c672"
}
import {
  to = authentik_group.ocisadmin
  id = "8935988c-a27a-4800-92d6-8516cae476e3"
}
import {
  to = authentik_group.ocisuser
  id = "47e0c01a-03a7-44ca-888a-651e8c0a532d"
}
import {
  to = authentik_group.omni-admin
  id = "3c115253-fa93-4a9e-a3d8-e6ac0249bcaf"
}
import {
  to = authentik_group.omni-user
  id = "7b317913-2fb3-4b54-bf0a-febff6c7188f"
}
import {
  to = authentik_group.omni-viewer
  id = "33941627-126b-40ae-92e5-92430122c40c"
}
import {
  to = authentik_group.proxmox-cedille-apps-admin
  id = "8ab9a585-0c62-47dd-b549-6d8fb77f1b6a"
}
import {
  to = authentik_group.proxmox-cedille-apps-user
  id = "e3b29389-4c60-4e57-9f2b-bc9f7181baa8"
}
import {
  to = authentik_group.proxmox-dci-admin
  id = "43256046-8049-43c1-b034-a74595a1f6ac"
}
import {
  to = authentik_group.proxmox-dci-user
  id = "43eae4e8-0514-434c-afbf-7a431e962c69"
}
import {
  to = authentik_group.proxmox-eclipse-admin
  id = "4d63ec94-3d56-460f-b555-eb9ab2d2fcb2"
}
import {
  to = authentik_group.proxmox-eclipse-user
  id = "6de561be-58a9-4efd-b1b2-ef42bf6fd7fd"
}
import {
  to = authentik_group.proxmox-gameservers-admin
  id = "26a01939-bbd3-4c28-b65f-4647072d27c5"
}
import {
  to = authentik_group.proxmox-gameservers-user
  id = "c292ab7c-0d31-41e8-b55f-40046dbe3e30"
}
import {
  to = authentik_group.proxmox-k8s-cedille-prod-admin
  id = "03ad15f1-11f1-4fc7-b949-b7adbaaf4b47"
}
import {
  to = authentik_group.proxmox-k8s-cedille-prod-user
  id = "241cdb16-6fc9-4c62-8cc1-3bb9229d8757"
}
import {
  to = authentik_group.proxmox-k8s-cedille-sandbox-admin
  id = "c3982be7-a987-4784-84c3-ea06aefa62bd"
}
import {
  to = authentik_group.proxmox-k8s-cedille-sandbox-user
  id = "9fdd31f6-2d9b-4feb-95a8-6b5c0daabcea"
}
import {
  to = authentik_group.proxmox-k8s-poc-admin
  id = "e223ea02-eb74-4df8-9255-1f057a0de0cb"
}
import {
  to = authentik_group.proxmox-k8s-poc-user
  id = "71258110-40a3-4a05-b771-4f508c8e063c"
}
import {
  to = authentik_group.proxmox-k8s-shared-admin
  id = "95b74efd-5ab5-481c-8c18-c3a7225b4d61"
}
import {
  to = authentik_group.proxmox-k8s-shared-user
  id = "8f2b220b-664e-4348-8c2a-44a246fabdec"
}
import {
  to = authentik_group.proxmox-lanets-admin
  id = "26aa9349-15b6-47ee-886a-c9e9ae61229e"
}
import {
  to = authentik_group.proxmox-lanets-user
  id = "d04ea8f6-571b-462b-8df4-b8a036cb881c"
}
import {
  to = authentik_group.proxmox-management-infra-admin
  id = "60746a4f-6f95-4a62-a27d-989683b25f2f"
}
import {
  to = authentik_group.proxmox-management-infra-user
  id = "4ec7d97f-64f8-4131-aaeb-fdcf21c620d7"
}
import {
  to = authentik_group.proxmox-networking-core-admin
  id = "4f03f142-5fcb-48d9-a529-607c99891a8c"
}
import {
  to = authentik_group.proxmox-networking-core-user
  id = "0cd5421b-2e63-415a-a77a-5fd01a4f60ba"
}
import {
  to = authentik_group.summercamp
  id = "ebedb6ab-e917-40a5-a68f-c5552f869087"
}
import {
  to = authentik_group.test-terraform
  id = "ba3a01a2-7572-49fc-ab2e-1030e973fa48"
}
import {
  to = authentik_rbac_role.outline_sync_service
  id = "d3098693-22f6-492b-943c-8db9af01c817"
}
import {
  to = authentik_rbac_role.ak-managed-role--user-2
  id = "80febf08-92aa-409a-a95e-601d78624719"
}
import {
  to = authentik_rbac_role.ak-managed-role--user-256
  id = "d611161b-dc34-4014-9747-6c6ea193f227"
}
import {
  to = authentik_rbac_role.ak-migrated-role--user-12
  id = "6953c7dc-78d0-4b5a-89ce-07ad072c8792"
}
import {
  to = authentik_rbac_role.ak-migrated-role--user-2
  id = "5d584232-a87e-4d9a-9d42-77539260e7d6"
}
import {
  to = authentik_rbac_role.ak-migrated-role--user-77
  id = "f5009c89-3e4f-41e6-832f-dd48c2b34cd0"
}
import {
  to = authentik_rbac_role.authentik_agent-users
  id = "cc761bdd-30be-4d09-a410-a78173059d82"
}
import {
  to = authentik_rbac_role.authentik_read-only
  id = "eab01ff6-bc1b-45af-800b-bfb14413cfe1"
}
import {
  to = authentik_rbac_role.club-eclipse
  id = "22f46a86-3004-46e0-8784-f0a4d7e409f2"
}
import {
  to = authentik_rbac_role.club-jdgets
  id = "3fe7e99e-efbf-4e56-88d5-b390c0ab69e0"
}
import {
  to = authentik_rbac_role.club-lanets
